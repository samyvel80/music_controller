...
from .views import DetailProductView, ListCreateProductView, UpdateProductView, DeleteProductView, ListProductView, ProductMixinsView, SearchListView, UserListView, CategoryListView
